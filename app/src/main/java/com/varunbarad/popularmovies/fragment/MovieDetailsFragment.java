...
public class MovieDetailsFragment extends Fragment implements Callback<MovieDetails> {
  ...
  private void showReviews() {
    ...
    MaterialDialog reviewDialog =
            new MaterialDialog(this.requireContext(), ModalDialog.INSTANCE)
                    .title(R.string.label_reviews, null)
                    .icon(R.drawable.ic_account_circle, null)
            .cancelable(true)
                    .negativeButton(R.string.label_ok, null, null);

    DialogListExtKt.customListAdapter(
            reviewDialog,
            reviewAdapter,
  ...
  private void showVideos() {
    ...
    MaterialDialog reviewDialog =
            new MaterialDialog(this.requireContext(), ModalDialog.INSTANCE)
                    .title(R.string.label_view_videos, null)
                    .icon(R.drawable.ic_video_library, null)
            .cancelable(true)
                    .negativeButton(R.string.label_ok, null, null);
